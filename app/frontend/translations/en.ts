export default {
  ...
  backend: {
    ...
    previous: "Previous",
    next: "Next",
    sendWelcome: "Send the welcome mail",
    welcomeSent: "Welcome mail sent.",
    welcomeFailed: "The welcome mail could not be sent.",
    confirmDeleteUser: "Really delete this user?",
    userDeleted: "User deleted.",
    userDeleteFailed: "The user could not be deleted.",
    confirmDeleteAccount: "Really delete this account and everything on it?",
    accountDeleted: "Account deleted.",
    accountDeleteFailed: "The account could not be deleted.",
    nav: {
      dashboard: "Dashboard",
      frontend: "Back to the app",
      users: "Users",
      accounts: "Accounts",
    ...
    columns: {
      ...
      account: "Account",
      createdAt: "Created",
      currentSignInAt: "Last signed in",
      actions: "Actions",
    },
    users: {
      title: "Users",
    ...
    accounts: {
      ...
      edit: "Edit {name}",
      empty: "No accounts.",
      firstUser: "The first user's email",
      expenses: "Expenses",
      logbook: "Logbook",
    },
  },
