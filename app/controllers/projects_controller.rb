class ProjectsController < ApplicationController
  ...
  def create
    ...
    if project.save
      ...
      render "new", error: I18n.t(:"messages.create.failure", resource: I18n.t(:"resources.messages.project"))
    end
  end
  ...
  def update
    ...
    if project.update_attributes(project_params)
      ...
      render "edit", error: I18n.t(:"messages.update.failure", resource: I18n.t(:"resources.messages.project"))
    end
  end
