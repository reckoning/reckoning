...
Rails.application.configure do
  ...
  # Redis cache store backs the session store; sessions persist across
  # restarts to match production behavior. Fragment caching itself is
  # gated on the rails dev:cache toggle.
